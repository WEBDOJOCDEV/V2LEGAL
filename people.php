 <?php include("headerpeople.php");?> 

 <!-- content begin -->
        <div class="no-bottom no-top" id="content">
            <div id="top"></div>
            <!-- section begin -->
            <section id="subheader" class="text-light" data-stellar-background-ratio=".2" data-bgimage="url(images/banner.jpg) top no-repeat">
            ...
            <section aria-label="section">
                <div class="container">
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Dr. V. Venkatesan, Managing Partner</a>
                                            <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Prem Sahayadhas, Partner</a>
                                            <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">B. Sudhir Kumar, Partner</a>
                                            <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">R. Ravindran, Partner</a>
                                            <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings1" role="tab" aria-controls="v-pills-settings" aria-selected="false">R. Sathyanarayanan, Senior Manager</a>
                                   ...
                                   <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                    ...
                                    <img src="images/Venkatesan.jpg"  class="img-responsive">
                                                <span class="p-title blue">FOUNDER</span><br>
                                                <h2>Dr.V.Venkatesan</h2><br>
                                                <span class="p-title blue">Managing Partner</span>
                                                    </div>
                    ...
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
					  ...
					  <div class="col-lg-4 center" >
                       <div class="post-content">
				<img src="images/Prem_Sahayadhas1.jpg"  class="img-responsive">
				
                            <h2 style="padding-top:20px;">Prem Sahayadhas</h2><br>
								 <span class="p-title blue">Partner</span>
				</div>
                </div>
                        <div class="col-lg-8 just">
                           
                                                        <p>Prem is a Partner at V2 Legal. He is a key member of the team in practising and lending his expertise to the Firm in strategizing on complicated litigation matters. Since the date of founding of the V2 Legal firm along with Managing Partner.
                            </p>
                            <p>
						 ...
						 <div class="col-lg-4 center">
                          <div class="post-content">
				<img src="images/Sudhir1.jpg" class="img-responsive">
				
                            <h2 style="padding-top:20px;">B. Sudhir Kumar</h2><br>
								 <span class="p-title blue">Partner</span>
				</div>
                </div>
				  <div class="col-lg-8 just">
                           
                                                        <p>Sudhir is a partner of V2 Legal with more than 21 years of rich experience in various branches of law. He has been doing criminal cases, employer & employee related cases, family cases, land disputes matters relating to intellectual properties, trade mark, civil, constitution etc.
                            </p>
                            <p>
					  ...
					  <div class="col-lg-4 center">
                       <div class="post-content">
				<img src="images/Ravindran.jpg" class="img-responsive">
				
                            <h2 style="padding-top:20px;">R. Ravindran </h2><br>
								 <span class="p-title blue">Partner</span>
                            ...
                            Ravindran holds a degree in Law and is registered to practice with the Bar Council of Tamil Nadu.
										 ...
										 <div class="tab-pane fade" id="v-pills-settings1" role="tabpanel" aria-labelledby="v-pills-settings-tab">
										  ...
										  <div class="row align-items-center">
										   <div class="col-lg-4 center">
                                           <div class="post-content">
				<img src="images/Sathya.jpg" class="img-responsive">
				 
                            <h2 style="padding-top:20px;">R. Sathyanarayanan  </h2><br>
								 <span class="p-title blue">Senior Manager</span>
				</div>
                </div>
                        <div class="col-lg-8 just">
                           
                                                            <p>Sathyam is a Senior Manger at V2 Legal. Has more than 36 years of experience with legal professionals. His expertise includes preparation of legal documents and compliances of the documentary formalities as per the requirement of all aspects of cases in criminal, civil and coordinating with clients in updating case status in day to day manner
                                </p>
                                <p>
                        ...
                        <div class="col-lg-8 just">
                                ...
                                Balaji is registered with the Bar Council of Tamil Nadu and holds a law degree.
										  ...
										  <div class="row align-items-center">
										   <div class="col-lg-4 center">
                                            <div class="post-content">
				<img src="images/DSC_7414_j.jpg" class="img-responsive">
				 
                            <h2 style="padding-top:20px;">V. Anantha Srinivasan</h2><br>
								 <span class="p-title blue">Counsel</span>
				</div>
                </div>
                        <div class="col-lg-8 just" >
                          
                                <p>Anantha Srinivasan is a junior advocate at V2 Legal, after enrolling as an advocate he is ably assisting the V2 team. he is proficient at drafting and preparing necessary legal documents for all types of cases. Anand is a young and enthusiastic lawyer with 4 years of experience.
                                </p>
                                <p>
                                ...
                                He completed his Business Communications (B.Com) degree at VELS UNIVERSITY, following which he has pursued LL.B (HONS) degree at SRM UNIVERSITY. He has enrolled at the Bar Council for Tamil Nadu and Puducherry and is currently practicing at the Madras High Court.
										  ...
										  <div class="row align-items-center">
										   <div class="col-lg-4 center">
                                            <div class="post-content">
				<img src="images/mukesh.jpg" class="img-responsive">
				 
                            <h2 style="padding-top:20px;">M. Mugesh</h2><br>
								 <span class="p-title blue">Counsel</span>
				</div>
                </div>
                        <div class="col-lg-8 just" style="    margin-bottom: 250px;">
                          
                                                        <p>M. Mugesh is a fresh graduate from SRM law college. He has been attending office since his college days. He is passionate about learning law and the nuances of law practice and works very hard.
                                                            He is sincere and gives his fullest efforts to see perfection on the assignment allotted to him. Very supportive to the seniors and the firm.
                                                            He possesses good Technical and digital knowledge to help V2legal office with the new normal to follow all the court proceedings diligently. He completed his 5 years B.A. LLB (Hons.) course in 2021. He was enrolled as an advocate before the Bar Council of Tamilnadu and Pondicherry.
                                                        </p>
                                                    </div>
                                                    </div>	
                                                    </div>
				...
				<img src="images/NithyaShree.jpg" class="img-responsive">
                        ...
                        <div class="col-lg-8 just">
                                ...
                                <p>Nithya Shree R is a young law graduate from SRM School of Law. She is ably assisting the V2 Legal Team since 2023 as an Advocate. Even during her college days, she sincerely attended as an intern till the completion of her law degree.</p>
                                <p>She was one of the toppers in the Law School. Her skill set in research was applauded and she won a Gold Medal in a research competition for 2023. She was awarded the as Best Speaker in Moot Competitions at intercollegiate level. She was selected as one of the interns for the Central Bureau of Investigation (CBI) and got a certification. Few of her publications were published in the college journal called ‘Lex Khronika’. Apart from academics, she is also a Carnatic singer and a Keyboard player.</p>
                                <p>She is enrolled as an Advocate in the Bar Council of Tamil Nadu and Puducherry and is practicing at the Madras High Court.</p>
